...
package org.ejml2.dense.row;

import org.ejml2.EjmlParameters;
import org.ejml2.LinearSolverSafe;
import org.ejml2.UtilEjml;
import org.ejml2.data.*;
import org.ejml2.dense.row.decomposition.lu.LUDecompositionAlt_DDRM;
import org.ejml2.dense.row.factory.LinearSolverFactory_DDRM;
import org.ejml2.dense.row.linsol.lu.LinearSolverLu_DDRM;
import org.ejml2.dense.row.linsol.svd.SolvePseudoInverseSvd_DDRM;
import org.ejml2.dense.row.misc.*;
import org.ejml2.dense.row.mult.MatrixMatrixMult_DDRM;
import org.ejml2.dense.row.mult.MatrixMultProduct_DDRM;
import org.ejml2.dense.row.mult.MatrixVectorMult_DDRM;
import org.ejml2.dense.row.mult.VectorVectorMult_DDRM;
import org.ejml2.interfaces.linsol.LinearSolverDense;
import org.ejml2.interfaces.linsol.ReducedRowEchelonForm_F64;
...
public class CommonOps_DDRM {
     ...
     * needed, then using {@link org.ejml2.interfaces.decomposition.LUDecomposition_F64} directly (or any
