...
package org.ejml2.dense.row.factory;

import org.ejml2.EjmlParameters;
import org.ejml2.UtilEjml;
import org.ejml2.data.DMatrix;
import org.ejml2.data.DMatrixRMaj;
import org.ejml2.dense.row.CommonOps_DDRM;
import org.ejml2.dense.row.EigenOps_DDRM;
import org.ejml2.dense.row.NormOps_DDRM;
import org.ejml2.dense.row.SpecializedOps_DDRM;
import org.ejml2.dense.row.decomposition.chol.CholeskyDecompositionBlock_DDRM;
import org.ejml2.dense.row.decomposition.chol.CholeskyDecompositionInner_DDRM;
import org.ejml2.dense.row.decomposition.chol.CholeskyDecompositionLDL_DDRM;
import org.ejml2.dense.row.decomposition.chol.CholeskyDecomposition_DDRB_to_DDRM;
import org.ejml2.dense.row.decomposition.eig.SwitchingEigenDecomposition_DDRM;
import org.ejml2.dense.row.decomposition.eig.SymmetricQRAlgorithmDecomposition_DDRM;
import org.ejml2.dense.row.decomposition.eig.WatchedDoubleStepQRDecomposition_DDRM;
import org.ejml2.dense.row.decomposition.hessenberg.TridiagonalDecompositionHouseholder_DDRM;
import org.ejml2.dense.row.decomposition.hessenberg.TridiagonalDecomposition_DDRB_to_DDRM;
import org.ejml2.dense.row.decomposition.lu.LUDecompositionAlt_DDRM;
import org.ejml2.dense.row.decomposition.qr.QRColPivDecompositionHouseholderColumn_DDRM;
import org.ejml2.dense.row.decomposition.qr.QRDecompositionHouseholderColumn_DDRM;
import org.ejml2.dense.row.decomposition.svd.SvdImplicitQrDecompose_DDRM;
import org.ejml2.interfaces.decomposition.*;
...
public class DecompositionFactory_DDRM {
    ...
    /**
     * <p>
     * Returns a {@link org.ejml2.dense.row.decomposition.chol.CholeskyDecompositionLDL_DDRM} that has been optimized for the specified matrix size.
     * </p>
     *
     * @param matrixSize Number of rows and columns that the returned decomposition is optimized for.
    ...
    /**
     * <p>
     * Returns a {@link org.ejml2.interfaces.decomposition.LUDecomposition} that has been optimized for the specified matrix size.
     * </p>
     *
    ...
    /**
     * <p>
     * Returns a {@link org.ejml2.interfaces.decomposition.QRDecomposition} that has been optimized for the specified matrix size.
     * </p>
     *
     * @param numRows Number of rows the returned decomposition is optimized for.
     * @param numCols Number of columns that the returned decomposition is optimized for.
