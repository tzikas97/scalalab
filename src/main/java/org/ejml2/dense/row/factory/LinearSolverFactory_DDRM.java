...
import org.ejml2.dense.row.decomposition.chol.CholeskyDecompositionCommon_DDRM;
...
import org.ejml2.dense.row.linsol.AdjustableLinearSolver_DDRM;
import org.ejml2.dense.row.linsol.chol.LinearSolverChol_DDRB;
import org.ejml2.dense.row.linsol.chol.LinearSolverChol_DDRM;
import org.ejml2.dense.row.linsol.lu.LinearSolverLu_DDRM;
import org.ejml2.dense.row.linsol.qr.*;
import org.ejml2.dense.row.linsol.svd.SolvePseudoInverseSvd_DDRM;
...
public class LinearSolverFactory_DDRM {
     ...
     * then the basic solution is returned.  See {@link org.ejml2.dense.row.linsol.qr.BaseLinearSolverQrp_DDRM}
