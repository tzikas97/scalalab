...
import org.ejml2.data.FMatrix;
import org.ejml2.data.FMatrixRMaj;
import org.ejml2.dense.row.CommonOps_FDRM;
import org.ejml2.dense.row.EigenOps_FDRM;
import org.ejml2.dense.row.NormOps_FDRM;
import org.ejml2.dense.row.SpecializedOps_FDRM;
import org.ejml2.dense.row.decomposition.chol.CholeskyDecompositionBlock_FDRM;
import org.ejml2.dense.row.decomposition.chol.CholeskyDecompositionInner_FDRM;
import org.ejml2.dense.row.decomposition.chol.CholeskyDecompositionLDL_FDRM;
import org.ejml2.dense.row.decomposition.chol.CholeskyDecomposition_FDRB_to_FDRM;
import org.ejml2.dense.row.decomposition.eig.SwitchingEigenDecomposition_FDRM;
import org.ejml2.dense.row.decomposition.eig.SymmetricQRAlgorithmDecomposition_FDRM;
import org.ejml2.dense.row.decomposition.eig.WatchedDoubleStepQRDecomposition_FDRM;
import org.ejml2.dense.row.decomposition.hessenberg.TridiagonalDecompositionHouseholder_FDRM;
import org.ejml2.dense.row.decomposition.hessenberg.TridiagonalDecomposition_FDRB_to_FDRM;
import org.ejml2.dense.row.decomposition.lu.LUDecompositionAlt_FDRM;
import org.ejml2.dense.row.decomposition.qr.QRColPivDecompositionHouseholderColumn_FDRM;
import org.ejml2.dense.row.decomposition.qr.QRDecompositionHouseholderColumn_FDRM;
import org.ejml2.dense.row.decomposition.svd.SvdImplicitQrDecompose_FDRM;
...
public class DecompositionFactory_FDRM {
    ...
    /**
     * <p>
     * Returns a {@link org.ejml2.dense.row.decomposition.chol.CholeskyDecompositionLDL_FDRM} that has been optimized for the specified matrix size.
     * </p>
     *
     * @param matrixSize Number of rows and columns that the returned decomposition is optimized for.
