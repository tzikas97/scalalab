...
import org.ejml2.dense.row.linsol.AdjustableLinearSolver_FDRM;
import org.ejml2.dense.row.linsol.chol.LinearSolverChol_FDRB;
import org.ejml2.dense.row.linsol.chol.LinearSolverChol_FDRM;
import org.ejml2.dense.row.linsol.lu.LinearSolverLu_FDRM;
import org.ejml2.dense.row.linsol.qr.*;
import org.ejml2.dense.row.linsol.svd.SolvePseudoInverseSvd_FDRM;
...
public class LinearSolverFactory_FDRM {
     ...
     * then the basic solution is returned.  See {@link org.ejml2.dense.row.linsol.qr.BaseLinearSolverQrp_FDRM}
