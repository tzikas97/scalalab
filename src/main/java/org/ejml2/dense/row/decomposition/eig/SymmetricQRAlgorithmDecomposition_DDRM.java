...
package org.ejml2.dense.row.decomposition.eig;

import org.ejml2.data.Complex_F64;
import org.ejml2.data.DMatrixRMaj;
import org.ejml2.dense.row.CommonOps_DDRM;
import org.ejml2.dense.row.decomposition.eig.symm.SymmetricQREigenHelper_DDRM;
import org.ejml2.dense.row.decomposition.eig.symm.SymmetricQrAlgorithm_DDRM;
import org.ejml2.dense.row.factory.DecompositionFactory_DDRM;
import org.ejml2.interfaces.decomposition.EigenDecomposition_F64;
import org.ejml2.interfaces.decomposition.TridiagonalSimilarDecomposition_F64;
 ...
 * @see org.ejml2.dense.row.decomposition.hessenberg.TridiagonalDecompositionHouseholder_DDRM
 *
 * @author Peter Abeles
 */
