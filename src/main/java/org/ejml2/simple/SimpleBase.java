...
public abstract class SimpleBase <T extends SimpleBase> implements Serializable {
     ...
     * see {@link org.ejml2.equation.Equation}.  The variable sequence alternates between variable and it's label String.
