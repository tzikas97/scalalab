...
package org.ejml2.interfaces.decomposition;
 ...
 * <li> Can incrementally add and remove columns from the decomposed matrix.  See {@link org.ejml2.dense.row.linsol.qr.AdjLinearSolverQr_DDRM} </li>
 * </ul>
 *
...
public interface QRDecomposition <T extends Matrix>
     ...
     * be called after {@link #decompose(org.ejml2.data.Matrix)} has
     * been called.
     * </p>
     *
     * <p>
     ...
     * called after {@link #decompose(org.ejml2.data.Matrix)} has been.
     * </p>
     * <p>
